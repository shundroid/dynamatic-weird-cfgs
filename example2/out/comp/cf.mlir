module {
  ...
  ^bb1(%0: i32, %1: i32):  // 2 preds: ^bb0, ^bb2
    ...
    cf.cond_br %5, ^bb2(%4, %0, %3, %1 : i32, i32, i32, i32), ^bb3 {handshake.name = "cond_br0"}
  ^bb2(%6: i32, %7: i32, %8: i32, %9: i32):  // pred: ^bb1
    %10 = arith.addi %9, %c1_i32 {handshake.name = "addi1"} : i32
    %11 = arith.addi %7, %8 {handshake.name = "addi2"} : i32
    cf.br ^bb1(%11, %10 : i32, i32) {handshake.name = "br1"}
  ^bb3:  // pred: ^bb1
